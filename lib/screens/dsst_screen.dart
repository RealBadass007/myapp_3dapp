...
class DsstScreen extends StatefulWidget {
  ...
  const DsstScreen({this.user_status, this.test_type});
  @override
...
class _DsstScreenState extends State<DsstScreen> {
  ...
  regulate() {
    ...
    if (taskNo == dsst_levels) {
      ...
      var dsst_results = {
        "dsst_levels": dsst_levels,
        "dsst_arr": userDsstReactArr,
        "dsst_err": DsstErrors,
      };
      ...
      if (widget.test_type == "Main") {
        Navigator.push(
            ...
            new MaterialPageRoute(
                builder: (context) => new BsstScreen(
                      dsst_results: dsst_results,
